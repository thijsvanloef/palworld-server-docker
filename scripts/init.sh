...
term_handler() {
  DiscordMessage "${DISCORD_PRE_SHUTDOWN_MESSAGE_TITLE}" "${DISCORD_PRE_SHUTDOWN_MESSAGE}" "in-progress" "${DISCORD_PRE_SHUTDOWN_MESSAGE_ENABLED}" "${DISCORD_PRE_SHUTDOWN_MESSAGE_URL}"
