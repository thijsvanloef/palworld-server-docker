...
| GENERATE_WORLD_OPTION   | Generate a WorldOption.sav file based on the compiled `PalWorldSettings.ini` (THIS WILL FORCE THE SERVER TO USE THE `WorldOption.sav` FILE FOR CONFIGURATIONS AND IGNORE `PalWorldSettings.ini`)                                                                            | false           | true/false                                                                                                 |
