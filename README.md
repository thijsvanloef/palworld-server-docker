...
| UE4SS_EXPERIMENTAL_INSTALL                 | Install latest experimental UE4SS package download and deployment.                                                                                                                                  | false                                                                                              | true/false                                                                                                        | 2.8.0            |
| UE4SS_EXPERIMENTAL_URL                     | Download URL for the experimental UE4SS package zip.                                                                                                                                                | `https://github.com/Okaetsu/RE-UE4SS/releases/download/experimental-palworld/UE4SS-Palworld.zip`   | .zip URL                                                                                                          | 2.8.0            |
...
Wine-based mod sync uses `WORKSHOP_MOD_IDS` or `/palworld/workshop-mods.txt`,
with `WORKSHOP_MOD_UPDATE_CRON` for periodic checks.
If you require the latest experimental UE4SS support, please set `UE4SS_EXPERIMENTAL_INSTALL=true`,
This will automatically download and extract the specified package and deploy the runtime files.

For paid/private Workshop items, save Steam session (`/palworld/.steam`) with `STEAM_USERNAME`.
