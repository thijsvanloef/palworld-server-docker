...
| WORKER_THREADS                             | Number of UE worker threads passed to -NumberOfWorkerThreadsServer when MULTITHREADING=true. Defaults to all host cores; set this when running with a CPU limit (cgroups/Kubernetes), e.g. to your CPU limit value | $(nproc --all)                                                                                     | !0                                                                                                                |                  |
