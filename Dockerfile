...
ENV HOME=/home/steam \
    ...
    DISCORD_PRE_UPDATE_BOOT_MESSAGE_TITLE=":arrows_counterclockwise: 업데이트" \
    DISCORD_PRE_UPDATE_BOOT_MESSAGE="서버 업데이트 중.." \
    DISCORD_PRE_UPDATE_BOOT_MESSAGE_URL= \
    DISCORD_PRE_UPDATE_BOOT_MESSAGE_ENABLED=true \
    DISCORD_POST_UPDATE_BOOT_MESSAGE_TITLE=":white_check_mark: 업데이트" \
    DISCORD_POST_UPDATE_BOOT_MESSAGE="서버 업데이트 완료!" \
    DISCORD_POST_UPDATE_BOOT_MESSAGE_URL= \
    DISCORD_POST_UPDATE_BOOT_MESSAGE_ENABLED=true \
    DISCORD_PRE_START_MESSAGE_TITLE=":white_check_mark: 시작" \
    DISCORD_PRE_START_MESSAGE="서버가 시작되었습니다!" \
    DISCORD_PRE_START_MESSAGE_URL= \
    DISCORD_PRE_START_MESSAGE_ENABLED=true \
    DISCORD_PRE_SHUTDOWN_MESSAGE_TITLE=":play_pause: 종료" \
    DISCORD_PRE_SHUTDOWN_MESSAGE="서버가 종료 중입니다.." \
    DISCORD_PRE_SHUTDOWN_MESSAGE_URL= \
    DISCORD_PRE_SHUTDOWN_MESSAGE_ENABLED=true \
    DISCORD_POST_SHUTDOWN_MESSAGE_TITLE=":pause_button: 종료" \
    DISCORD_POST_SHUTDOWN_MESSAGE="서버가 종료되었습니다!" \
    DISCORD_POST_SHUTDOWN_MESSAGE_URL= \
    DISCORD_POST_SHUTDOWN_MESSAGE_ENABLED=true \
    DISCORD_PLAYER_JOIN_MESSAGE_TITLE=":green_square: 접속" \
    DISCORD_PLAYER_JOIN_MESSAGE="player_name 님이 서버에 접속하였습니다." \
    DISCORD_PLAYER_JOIN_MESSAGE_URL= \
    DISCORD_PLAYER_JOIN_MESSAGE_ENABLED=true \
    DISCORD_PLAYER_LEAVE_MESSAGE_TITLE=":red_square: 퇴장" \
    DISCORD_PLAYER_LEAVE_MESSAGE="player_name 님이 서버에서 퇴장하였습니다." \
    DISCORD_PLAYER_LEAVE_MESSAGE_URL= \
    DISCORD_PLAYER_LEAVE_MESSAGE_ENABLED=true \
    DISCORD_PRE_BACKUP_MESSAGE_TITLE=":arrows_counterclockwise: 백업" \
    DISCORD_PRE_BACKUP_MESSAGE="백업파일 생성중.." \
    DISCORD_PRE_BACKUP_MESSAGE_URL= \
    DISCORD_PRE_BACKUP_MESSAGE_ENABLED=true \
    DISCORD_POST_BACKUP_MESSAGE_TITLE=":white_check_mark: 백업" \
    DISCORD_POST_BACKUP_MESSAGE="백업파일 생성됨 : file_path" \
    DISCORD_POST_BACKUP_MESSAGE_URL= \
    DISCORD_POST_BACKUP_MESSAGE_ENABLED=true \
    DISCORD_PRE_BACKUP_DELETE_MESSAGE_TITLE=":red_circle: 백업" \
    DISCORD_PRE_BACKUP_DELETE_MESSAGE="old_backup_days 일 보다 오래된 파일을 제거중.." \
    DISCORD_PRE_BACKUP_DELETE_MESSAGE_URL= \
    DISCORD_PRE_BACKUP_DELETE_MESSAGE_ENABLED=true \
    DISCORD_POST_BACKUP_DELETE_MESSAGE_TITLE=":red_circle: 백업" \
    DISCORD_POST_BACKUP_DELETE_MESSAGE="old_backup_days 일 보다 오래된 파일을 제거하였습니다." \
    DISCORD_POST_BACKUP_DELETE_MESSAGE_URL= \
    DISCORD_POST_BACKUP_DELETE_MESSAGE_ENABLED=true \
    DISCORD_ERR_BACKUP_DELETE_MESSAGE_TITLE="" \
